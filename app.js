...
const PROFILES = [
  {
    name: "Jhonathan Alexis Vasquez Zurita",
    age: 27,
    gender: "hombre",
    table: "Mesa #5",
    occupation: "Tecnico Motorizado, Peleador de Jiu-Jitsu (BJJ-MMA)",
    quote: "la hora es la hora,porque antes de la hora, no es la hora y después la hora tampoco es la hora.",
    interests: ["viajar", "MMA", "deporte extremo", "motos", "futbol"],
    accent: "#6f715f",
    accent2: "#31352d",
  ...
  {
    name: "Felix Alejandro Balmaceda Hernandez",
    age: 35,
    gender: "hombre",
    table: "Mesa #14",
    occupation: "tronchatodo Supervisor de operaciones, tu mariachi.",
    quote: "TU TRANQUILA, Y YO NERVIOSO BEBÉ",
    interests: ["Viajar", "cantar", "bailar"],
    accent: "#b99b7d",
    accent2: "#46382e",
  ...
  {
    name: "Jean Pierre Alfaro Mosayhuate",
    age: 33,
    gender: "hombre",
    table: "Mesa #6",
    occupation: "Esclavo de la Agro exportación",
    quote: "Si vino a Ica y no tomó vino entonces, para qué mrd vino 🍷",
    interests: ["Runner", "viajes", "trekking", "Alianza Lima 💙"],
    accent: "#bd7a4f",
    accent2: "#6a3b28",
  ...
  {
    name: "Wilbert Echevarría López",
    age: 31,
    gender: "hombre",
    table: "Mesa #16",
    occupation: "Serenazgo",
    quote: "ARRE PORQUE ARRE O OIGAA!!",
    interests: ["El fútbol", "la música", "el arte de hacer el amor"],
    accent: "#273a5a",
    accent2: "#111a2b",
  ...
  },
  {
    ...
    gender: "mujer",
    table: "Mesa 8",
    occupation: "Control de calidad - rubro Pesqueria",
    quote: "En un mundo de cuerdos , el loco es el más Feliz 😋",
    interests: ["Negocios", "los animes", "tomar tragos y divertirme"],
    accent: "#9f314d",
    accent2: "#4a1827",
